...
- **macOS (Apple Silicon, M1+)** — `KobyCopy_0.1.5_aarch64.dmg`
- **macOS (Intel)** — `KobyCopy_0.1.5_x64.dmg`
- **Windows (x64)** — `KobyCopy_0.1.5_x64-setup.exe`
...
4. Publish. Download URLs follow the pattern:
   ```
   https://github.com/kobycopy/kobycopy-releases/releases/download/v0.1.5/KobyCopy_0.1.5_aarch64.dmg
   ```
